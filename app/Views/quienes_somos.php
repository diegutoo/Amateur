...
<div class="slider-wrapper">
  <div class="slider-contenedor">
    <img src="<?= base_url('img/referencia1.jpg'); ?>" alt="Referencia 1" class="slider-img activa">
    <img src="<?= base_url('img/bjj.jpg'); ?>" alt="Referencia 2" class="slider-img">
    <img src="<?= base_url('img/referencia3.jpg'); ?>" alt="Referencia 3" class="slider-img">
  </div>
</div>
</section>
